...
const BOARD_ONLY_OPERATIONS = new Set([
  ...
  "POST /api/companies/{companyId}/data-connections/{connectionId}/forget-host-key",
...
for (const route of [
  ...
  ["post", "/api/companies/{companyId}/data-connections/{connectionId}/forget-host-key", "Forget the pinned SFTP host key so the next Test trusts the server's key afresh (SFTP connections only; switches the connection off until it is tested again)", undefined],
