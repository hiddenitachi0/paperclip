...
import { DashboardNow } from "./pages/DashboardNow";
...
import { InstanceClaudeAuth } from "./pages/InstanceClaudeAuth";
import { InstanceSecurity } from "./pages/InstanceSecurity";
import { InstanceCrossCompanyAccess } from "./pages/InstanceCrossCompanyAccess";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="dashboard/now" element={<DashboardNow />} />
      ...
      <Route path="company/settings/instance/claude" element={<InstanceClaudeAuth />} />
      <Route path="company/settings/instance/security" element={<InstanceSecurity />} />
      <Route path="company/settings/instance/cross-company-access" element={<InstanceCrossCompanyAccess />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="onboarding" element={<OnboardingRoutePage />} />
          <Route path="simple" element={<UnprefixedBoardRedirect />} />
          <Route path=":companyPrefix/simple" element={<SimpleMode />} />
