...
import { Clock3, Cpu, Eye, FlaskConical, KeyRound, MonitorCog, Puzzle, Settings, Shield, ShieldCheck, SlidersHorizontal, UserRoundPen } from "lucide-react";
    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to={`${INSTANCE_SETTINGS_PATH_PREFIX}/claude`} label="Claude sign-in" icon={KeyRound} end />
          ...
          <SidebarNavItem to={`${INSTANCE_SETTINGS_PATH_PREFIX}/security`} label="Security" icon={ShieldCheck} end />
          <SidebarNavItem to={`${INSTANCE_SETTINGS_PATH_PREFIX}/cross-company-access`} label="Cross-company access" icon={Eye} end />
