...
import { WeeklyCheckupCard } from "../components/WeeklyCheckupCard";
...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* DUR-62: the weekly check-up lives here, next to "Run check-up now". */}
      <WeeklyCheckupCard companyId={selectedCompanyId!} />
